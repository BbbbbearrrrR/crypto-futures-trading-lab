...
import backtest_breakout as bb   # reuse prepare(), _apply_params()
...
STATE_FILE       = Path("paper_state_breakout.json")
TRADE_LOG_FILE   = Path("paper_trades_breakout.csv")
BEST_PARAMS_FILE = Path("results/breakout/best_params.json")
